...
function About() {
  return (
    <div className='font-serif md:border-[1px] md:border-blue-300 w-auto md:w-[96%] md:ml-[2%] rounded-3xl p-4 md:p-0'>
        ...
        <div className='w-auto md:w-[90%] md:ml-[3%] mt-14 flex flex-col lg:flex-row mb-6'>
            <div className='md:ml-[15%] lg:ml-[5%]'>
                <Image src={profile} alt='profile' width={1000} height={1000} className='h-[380px] w-[100%] max-w-[450px] shadow-2xl shadow-fontColors  rounded-3xl'/>
            ...
            <div className='w-auto md:w-[94%] mt-8 md:mt-8 lg:mt-0 md:ml-[5%]'>
                ...
                <div className='w-auto md:w-[100%] mt-6 space-y-2 md:space-y-2 lg:space-y-1'>
