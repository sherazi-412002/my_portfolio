...
function About() {
  return (
    <div>
        <div className='font-serif md:border-[1px] md:border-blue-300 w-screen md:w-[96%] md:ml-[2%] rounded-3xl'>
        ...
        <div className='w-screen md:w-[90%] md:ml-[3%] mt-14 flex flex-col lg:flex-row mb-6 p-2 md:p-0'>
            ...
            <div className='w-screen md:w-[94%] mt-8 md:mt-8 lg:mt-0 md:ml-[5%] p-2 md:p-0'>
                ...
                <div className='w-screen md:w-[100%] mt-6 space-y-2 md:space-y-2 lg:space-y-1 p-2 md:p-0'>
